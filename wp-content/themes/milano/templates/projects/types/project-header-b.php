...
<div class="agncy-ph-sp">
	...
	<div class="agncy-ph-sp-fi" style="background-image:url(<?php echo esc_attr( $prj_img ); ?>)">
		<?php if ( $prj_use_video ) : ?>
			<a class="agncy-ph-sp-open-video" href="<?php echo esc_attr( $prj_video ); ?>">
				<span class="screen-reader-text"><?php esc_html_e( 'Play video', 'agncy' ); ?></span>
			</a>
		<?php endif; ?>
	</div>
