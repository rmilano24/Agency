...
$show_nav = agncy_show_post_nav() && ( ! empty( $prev_post ) || ! empty( $next_post ) );
...
if ( $show_nav || $show_share ) : ?>
	...
	<?php
		if ( $show_share ) {
			do_action( 'agncy_post_navigation' );
		}
	?>
	...
	<?php if ( $show_nav ) : ?>
		...
		<?php
			if ( $prev_post ) {
				...
				$prev_post_date      = get_the_date( '', $prev_post->ID );
				...
				printf( '<div class="%s">', esc_attr( $prev_classes ) );
					printf( '<a href="%s" class="agncy-sp-ni">', esc_url( $prev_post_permalink ) );

						echo agncy_load_svg( 'img/arrow.svg' );

						echo '<span class="agncy-sp-ni_w-i">';

							printf( '<span class="agncy-previous-post-label agncy-sp-label">%s</span>', esc_html__( 'Previous post', 'agncy' ) );

							printf( '<span class="agncy-sp-date">%s</span>', esc_html( $prev_post_date ) );
			...
			if ( $next_post ) {
				...
				printf( '<div class="%s">', esc_attr( $next_classes ) );
					printf( '<a href="%s" class="agncy-sp-ni">', esc_url( $next_post_permalink ) );

						echo agncy_load_svg( 'img/arrow.svg' );

						echo '<span class="agncy-sp-ni_w-i">';

							printf( '<span class="agncy-next-post-label agncy-sp-label">%s</span>', esc_html__( 'Next post', 'agncy' ) );

							printf( '<span class="agncy-sp-date">%s</span>', esc_html( $next_post_date ) );
