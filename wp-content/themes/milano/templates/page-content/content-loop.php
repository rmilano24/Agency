					...
					<div class="<?php echo esc_attr( implode( ' ', agncy_blog_loop_wrapper_class() ) ) ?>">
						<?php while ( have_posts() ) : the_post(); ?>
							...
							<?php if ( function_exists( 'ev_get_option' ) ) : ?>
								...
								<?php $index_loop_style = ev_get_option( 'index_loop_style' ); ?>

								<?php if ( $index_loop_style == 'masonry' ) : ?>
									<?php get_template_part( 'content-masonry' ); ?>
								<?php elseif ( $index_loop_style == 'stream' ) : ?>
						...
						<?php
							if ( function_exists( 'ev_get_option' ) ) {
								$is_home = is_home() && ev_get_option( 'index_loop_style' ) == 'masonry';
